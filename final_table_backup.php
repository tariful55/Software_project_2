...
<style>
    ...
    table {
        ...
        background-color: #111; /* Dark background for tables */
        color: #fff; /* White text */
        box-shadow: 0 0 10px rgba(77, 191, 0, 0.3); /* Green glow effect */
    }
    ...
    /* Table headers */
    th {
        background-color: #4dbf00; /* Green header */
        color: #000; /* Black text in header for contrast */
    }

    /* Row coloring for better separation */
